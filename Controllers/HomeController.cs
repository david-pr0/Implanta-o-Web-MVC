...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente cliente1 = new Cliente(1, "David Rafael", "123.456.789-00", "rafael.santos.jb22@gmail.com", "Scooby");
        Cliente cliente2 = new Cliente(2, "William Henry", "039.618.250-09", "bill@microsoft.com", "Bug");
